...
```{r}
#setwd({data_dir})
exp_info <- data.table::fread("ENCODE_Signature/experiment_report_2021_10_11.tsv")

bam_meta <- data.table::fread("ENCODE_Signature/metadata.tsv")
...
write.csv(shrink_LFC_df, "ENCODE_Signature/shrinkLFC_CRISPRi.csv", row.names = T, quote = F)
```
